...
def main():
    ...
    args = parser.parse_args(["--corpus_path=dataset/corpora_bigram.txt","--vocab_path=dataset/vocab.txt","--seq_length=512","--dataset_path=dataset.pt","--processes_num=80","--target=bertflow"])
